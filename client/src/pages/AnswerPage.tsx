      ...
      <section style={{ background: "#fff", padding: "36px 16px" }}>
        <div style={{ maxWidth: "480px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
            <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663402604684/JbWPLUXVZdQfasoqMu5Tg2/nitouryu_katana_6ca1165a.png" alt="二刀流（大刀・小刀）" style={{ width: "100%", maxWidth: "280px", display: "block", margin: "0 auto" }} />
